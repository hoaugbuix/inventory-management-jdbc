...
@MatKhau nvarchar(50)
as
	select MaNhanVien, HoTenNhanVien from NhanVien a
				where a.taikhoan = @TaiKhoan
				and PWDCOMPARE(@MatKhau, a.MatKhau) = 1 

create proc sp_DanhSachTacGia
as
	Select MaTacGia, HoTenTacGia, DiaChi from TacGia
	


create proc sp_DanhSachLoaiSach
as
	Select MaLoai, LoaiSach, KieuSach from LoaiSach
	
	
create proc sp_LuuTacGia
...
create proc sp_CapNhatLoaiSach
@MaLoai int,
@LoaiSach nvarchar(100),
@KieuSach nvarchar(100)
as
...
create proc sp_rptThongKeSach
as
	Select a.MaTacGia, a.HoTenTacGia, a.DiaChi, b.MaSach, b.TenSach, b.SoLuong, c.MaLoai, c.LoaiSach, c.KieuSach
	from TacGia a, Sach b, LoaiSach c
	where a.MaTacGia = b.MaTacGia
